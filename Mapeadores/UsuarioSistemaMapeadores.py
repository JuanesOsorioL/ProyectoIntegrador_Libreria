...
def dto_a_usuario_sistema(dto: UsuarioSistemaDTO) -> UsuarioSistema:
    return UsuarioSistema(dto.id, dto.usuario_id, dto.username, dto.password_hash)

def usuario_sistema_a_dto(usuario: UsuarioSistema) -> UsuarioSistemaDTO:
    return UsuarioSistemaDTO(usuario.id, usuario.usuario_id, usuario.username, usuario.password_hash)

def fila_a_usuario_sistema(fila: tuple) -> UsuarioSistema:
    return UsuarioSistema(fila[0],fila[1],fila[2],fila[3])
...
def fila_a_usuario_sistema(fila: tuple) -> UsuarioSistema:
    return UsuarioSistema(fila[0],fila[1],fila[2],fila[3],fila[4],fila[5],None)
    ...
    def dto_a_usuario_sistema(dto:UsuarioSistemaDTO, usuario:Usuario) -> UsuarioSistema:
    return UsuarioSistema(dto.get_id(), dto.get_usuario_id(), dto.get_nombre_usuario(), None, dto.get_contrasena(), None, usuario)
